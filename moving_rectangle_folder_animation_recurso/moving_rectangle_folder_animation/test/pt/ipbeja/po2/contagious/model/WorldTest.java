...
class WorldTest {
    ...
    @BeforeEach
    public void setUp() {
        this.world = new World(this.view, 10, 10, 0, 0, 0, 0, 0);
    }
    ...
    void testMovement() {
        ...
        boolean validMove = this.world.movePerson(4, 4, 4, 5);
        assertTrue(validMove);
        assertTrue(this.world.getCell(4, 4).isEmpty());
        assertTrue(this.world.getCell(4, 5).isHealthy());
    }
    @Test
